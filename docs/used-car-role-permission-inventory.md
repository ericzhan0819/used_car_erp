...
## Phase P1-D-A Follow-up

Sensitive fields have been moved out of permlevel 0 according to the P1-C design.

Used Car business roles still have no custom DocType permissions.
