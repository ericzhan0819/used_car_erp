...
下一步可進 Step 7A：Guided Final Payment Dialog Runtime。Step 7A 應把車輛頁「建立尾款收款」改為「收尾款」，沿用既有 `vehicle_reservation_service.create_final_payment_for_active_reservation`，不新增 schema、不改會計流程。
