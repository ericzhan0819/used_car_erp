...
下一步可進 Step 6A：Guided Reservation / Deposit Dialog Runtime。Step 6A 應把車輛頁「建立訂金保留」改為「收訂金並保留」，沿用既有 `vehicle_reservation_service.create_reservation`，不新增 schema、不改會計流程。
